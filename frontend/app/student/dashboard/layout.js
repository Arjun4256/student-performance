        ...
        <div className="flex min-h-screen bg-[#F1F5F9]">
            ...
            <div className="fixed top-0 left-0 right-0 z-40 flex h-16 items-center justify-between border-b border-[#E2E8F0] bg-white px-6 shadow-sm md:hidden">
                <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-black text-[#0F172A] uppercase tracking-tighter">Student Portal</span>
                </div>
                <button
                ...
                <div className="mb-10 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                            <span className="text-lg font-black text-[#0F172A] leading-tight">Student</span>
                            <span className="text-[10px] font-black text-[#6366F1] uppercase tracking-widest">Portal</span>
                        </div>
                    </div>
