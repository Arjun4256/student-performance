        ...
        <div className="flex min-h-screen items-center justify-center bg-zinc-50 px-4 dark:bg-black">
            <div className="w-full max-w-md rounded-2xl bg-white p-8 shadow-xl dark:bg-zinc-900">
                <div className="mb-8 text-center">
                    <h1 className="text-3xl font-bold text-zinc-900 dark:text-white">Student Signup</h1>
                    <p className="mt-2 text-zinc-600 dark:text-zinc-400">Create your account to track performance</p>
                </div>
                ...
                <p className="mt-8 text-center text-sm text-zinc-600 dark:text-zinc-400">
                    ...
                    <Link href="/student/login" className="font-semibold text-zinc-900 hover:underline dark:text-white">
                        Login
                    </Link>
                </p>
            </div>
