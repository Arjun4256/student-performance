...
export const adminApi = {
    ...
    getAllPlacements: () => apiFetch("/api/admin/placement"),
    ...
    getPlacedStudents: () => apiFetch("/api/admin/placement/placed"),
    getUnplacedStudents: () => apiFetch("/api/admin/placement/unplaced"),
    ...
    // Dashboard & Stats
    getOverviewStats: () => apiFetch("/admin/dashboard/stats"),
    updateFacultyStatus: (login_id, is_active) => apiFetch(`/admin/dashboard/faculty/status/${login_id}`, {
        method: "PUT",
